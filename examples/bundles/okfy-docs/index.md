...
* [Import Local Markdown](guides/import-local-markdown.md) - Use okfy import for local Markdown, MDX, staticsite sources, or Obsidian vaults. The same command recognizes Obsidian knowledge semantics automatically, with no extra flags needed.
